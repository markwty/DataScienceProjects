...
select get_available_instructors(1, '2021-04-12', '2021-04-20');--okay
insert into Rooms values(1, 'room 1', 10);
select add_course_offering(1,1,11.5,'2020-10-01'::date,'2020-10-01'::date,5,6,'[["2021-04-12",10,1],["2021-04-13",14,1]]'::json);
select get_available_instructors(1, '2021-04-12', '2021-04-20');--clash

select get_available_instructors(2, '2020-10-26', '2020-11-05');--shared specialisation
...
select get_available_instructors(2, '2020-10-26', '2020-11-05');

select remove_employee(5, '2021-04-10');
select get_available_instructors(3, '2021-04-07', '2021-04-13');--departed halfway